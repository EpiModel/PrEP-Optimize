...
table_optim <- table_optim %>% mutate(poip_spending = commas(round(poip * cost.i, 0)),
                                      ...
                                      cum_inc = paste0(format(round(1199.484 - 1199.484*infAvert/100, 1), nsmall = 1),
                                                       " (",
                                                       format(round(1199.484 - 1199.484*pred.ll/100, 1), nsmall = 1),
                                                       ", ",
                                                       format(round(1199.484 - 1199.484*pred.ul/100, 1), nsmall = 1),
                                                       ")"),
                                      infections_averted_ct = paste0(format(round(1199.484*infAvert/100, 1), nsmall = 1),
                                                                     " (",
                                                                     format(round(1199.484*pred.ll/100, 1), nsmall = 1),
                                                                     ", ",
                                                                     format(round(1199.484*pred.ul/100, 1), nsmall = 1),
                                                                     ")"),
                                      infections_averted_pct = paste0(format(round(infAvert, 1), nsmall = 1),
                                                                      " (",
                                                                      format(round(pred.ll, 1), nsmall = 1),
                                                                      ", ",
                                                                      format(round(pred.ul, 1), nsmall = 1),
                                                                      ")"),
                                      dollars_per_inf = paste0(commas(round(budget / (1199.484*infAvert/100), 0)),
                                                               " (",
                                                               commas(round(budget / (1199.484*pred.ul/100), 0)),
                                                               ", ",
                                                               commas(round(budget / (1199.484*pred.ll/100), 0)),
                                                               ")"),
  ...
  select(c(poip, poac, porc,
           ...
           poip_spending_pct, poac_spending_pct, porc_spending_pct, cum_inc,
