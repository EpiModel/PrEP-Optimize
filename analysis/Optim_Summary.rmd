...
These are referred to synonymously as "Uptake Capacity", "Adherence Capacity", and "Retention Capacity".
...
```{r vis_gam}
vis.gam(gam, view = c("PORC", "POIP"), type = "response", theta = -45, xlab = "Retention Capacity", ylab = "Uptake Capacity", zlab = "Infections Averted")
vis.gam(gam, view = c("PORC", "POIP"), plot.type = "contour", type = "response", xlab = "Retention Capacity", ylab = "Uptake Capacity", main = "Infections Averted Contour")
```

Uptake/Adherence Interaction plots:

```{r}
vis.gam(gam, view = c("POAC_yr", "POIP"), type = "response", theta = -45, xlab = "Adherence Capacity", ylab = "Uptake Capacity", zlab = "Infections Averted")
vis.gam(gam, view = c("POAC_yr", "POIP"), plot.type = "contour", type = "response", xlab = "Adherence Capacity", ylab = "Uptake Capacity", main = "Infections Averted Contour")
```

Adherence/Retention Interaction plots:

```{r}
vis.gam(gam, view = c("POAC_yr", "PORC"), type = "response", theta = -45, xlab = "Adherence Capacity", ylab = "Retention Capacity", zlab = "Infections Averted")
vis.gam(gam, view = c("POAC_yr", "PORC"), plot.type = "contour", type = "response", xlab = "Adherence Capacity", ylab = "Retention Capacity", main = "Infections Averted")
```
