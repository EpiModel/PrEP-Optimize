...
load("C:/Users/Greg/Desktop/PrEP-Optimize/analysis/optim_data/optim_res_table.rda")
table_optim <- res

load("C:/Users/Greg/Desktop/PrEP-Optimize/analysis/optim_data/optim_res_adh.rda")
adh_optim <- res

load("C:/Users/Greg/Desktop/PrEP-Optimize/analysis/optim_data/optim_res.rda")
...
saveRDS(df_prep_10yr, file = "analysis/optim_data/df_prep_10yr.rda")  
```
...
saveRDS(gam, file = "analysis/optim_data/gam.rda")
```
...
saveRDS(porc, file = "analysis/optim_data/fig10_df.rda")
...
saveRDS(poac, file = "analysis/optim_data/fig11_df.rda")
...
saveRDS(poip, file = "analysis/optim_data/fig12_df.rda")
...
saveRDS(res_plot, file = "analysis/optim_data/res_plot.rda")
...
saveRDS(res_plot_area_prop, file = "analysis/optim_data/res_plot_area_prop.rda")
...
saveRDS(res_plot_area, file = "analysis/optim_data/res_plot_area.rda")
...
saveRDS(res_plot_area_prop, file = "analysis/optim_data/res_plot_area_prop_adh.rda")
...
saveRDS(res_plot_area, file = "analysis/optim_data/res_plot_area_adh.rda")
